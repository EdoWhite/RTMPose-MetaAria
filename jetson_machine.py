...
def visualize(frame,results,output_dir,frame_id,thr=0.5,resize=1280,skeleton_type='coco'):
...
def main():
    ...
    while True:
        ...
        if not visualize(frame,results,args.output_dir,frame_id,skeleton_type=args.skeleton):
            break
        frame_id += 1
